...
router.get("/gamewise2",authorize(),   controller.gamewise2);
...
router.get("/hand/details2",authorize(),   controller.gameAudit2)
router.get("/hand/details_game", authorize(),  controller.gameAuditgamewise)
