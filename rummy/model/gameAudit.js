...
let GameAuditSchema = new Schema({
    tableId: { type: mongoose.Schema.Types.ObjectId, ref: 'rm_table' },
    cardInfoId: { type: mongoose.Schema.Types.ObjectId, ref: 'rm_cardinfo' },
    userId: { type: mongoose.Schema.Types.ObjectId, ref: 'users' },
    gameId: { type: mongoose.Schema.Types.ObjectId, ref: 'rm_game' },
...
const GameAudit = mongoose.model('rm_gameAudit',GameAuditSchema);
